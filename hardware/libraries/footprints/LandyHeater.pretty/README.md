...
- `PROVISIONAL_Murata_LQH3NPZ_JR` hält die zwei elektrischen Pads von L3/L4 eindeutig auseinander. Seine Geometrie ist bewusst nur ein sichtbarer Platzhalter; sie muss vor Phase 3 gegen das aktuelle Murata-ECAD-Modell und die empfohlene Anschlussfläche des `LQH3NPZ470MJR` ersetzt oder schriftlich freigegeben werden.
